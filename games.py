...
def human_player(game, state):
    ...
    print(state.to_move, "es tu turno.")
    acciones = game.actions(state)
    print("Movimento disponible:", acciones)
    move = None
    while move not in acciones:
        try:
            move_input = input("Ingrese su movimiento: ")
            move = int(move_input)
            if move not in acciones:
